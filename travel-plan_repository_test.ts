...
import { PrismaClient, TravelPlan } from '@prisma/client';
...
describe('TravelPlanRepository', () => {
  ...
  describe('create', () => {
    it('should create a new travel plan', async () => {
      const mockData = {
        ...
        destination: 'Paris',
        type: "VACATION" as "VACATION" | "RELOCATION",
        budgetLevel: 'MEDIUM',
        days: 7,
        budget: 5000,
  ...
  describe('findByIdAndUserId', () => {
    it('should return a travel plan by id and user id', async () => {
